...
export default function NewTaskPage() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      // We check if it is a redirect error and rethrow it if it is, otherwise we handle the error.
      const isRedirect =
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="rounded-2xl border border-zinc-900 bg-zinc-900/20 p-6 sm:p-8 backdrop-blur-sm">
        ...
        <p className="text-sm text-zinc-400 mb-6">
          Nhập thông tin chi tiết để lên lịch và lập kế hoạch cho công việc mới của bạn.
        </p>
