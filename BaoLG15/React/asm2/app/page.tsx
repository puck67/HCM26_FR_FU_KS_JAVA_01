...
export const metadata: Metadata = {
  title: "Home | ASM2 TaskFlow",
  description: "Manage your tasks efficiently with ASM2 TaskFlow - a Next.js powered task manager.",
};
...
const features = [
  {
    ...
    desc: "Create, update, and delete tasks with full CRUD operations powered by Next.js Server Actions.",
    ...
    <div className="space-y-20">
      ...
      <section className="relative text-center pt-12 pb-8">
        ...
        <div className="relative space-y-6 fade-in-up">
          ...
          <p className="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
            A modern task management application built with Next.js 14, featuring
      ...
      <section className="glass-card rounded-3xl p-10 text-center relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-gray-400 mb-6">Create your first task and start managing your work efficiently.</p>
          <Link
            href="/tasks/new"
            id="cta-create-task"
