...
// Note: metadata must be in a separate server component or layout when using "use client"
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2 text-gray-500 text-sm mb-4">
          <a href="/tasks" className="hover:text-gray-300 transition-colors">Tasks</a>
        ...
        <p className="text-gray-400 text-sm">Fill in the details below to create a new task.</p>
      </div>
      ...
      <div className="glass-card rounded-3xl p-8">
        ...
        <TaskForm mode="create" onSubmit={createTask} />
      </div>
      ...
      <div className="glass-card rounded-2xl p-5 flex items-start gap-3">
        ...
        <div>
          ...
          <ul className="text-xs text-gray-500 space-y-1">
            <li>• Task name is required and must be at most 40 characters</li>
            <li>• Description is optional but helps track context (max 200 chars)</li>
            <li>• After creating, you can mark tasks as complete from the task list</li>
          </ul>
        </div>
      </div>
    </div>
