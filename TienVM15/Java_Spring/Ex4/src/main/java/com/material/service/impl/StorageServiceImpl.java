...
public class StorageServiceImpl implements StorageService {
    ...
    private final List<String> allowedExtensions = Arrays.asList("pdf", "docx", "pptx", "zip", "txt");
    ...
    public String store(MultipartFile file) {
        ...
        try {
            ...
            if (file.getSize() > 10 * 1024 * 1024) { // 10MB limit check
            ...
            if (!allowedExtensions.contains(fileExtension)) {
                throw new StorageException("Unsupported file format. Only PDF, DOCX, PPTX, ZIP, TXT are allowed.");
            }
