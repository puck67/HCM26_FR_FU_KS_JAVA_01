...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            running = processInput(sc, service);
    ...
    private static boolean processInput(Scanner sc, HotelRoomService service) {
        return getNumber(sc)
            .map(choice -> runCommand(choice, sc, service))
            .orElseGet(() -> {
    ...
    private static Optional<Integer> getNumber(Scanner sc) {
        try {
    ...
    private static boolean runCommand(int choice, Scanner sc, HotelRoomService service) {
        System.out.println();
        switch (choice) {
