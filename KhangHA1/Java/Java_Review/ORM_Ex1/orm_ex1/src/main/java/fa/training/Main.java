...
/**
 * Entry point — lambda-based menu navigation.
 * Pattern mirrors the LibraryManagement Main class.
 */
public class Main {
    ...
    private static void studentMenu() {
        ...
        Map<Integer, Runnable> actions = Map.of(
                ...
                2, () -> studentController.displayAllStudents(),
                3, () -> studentController.findStudentById(),
                4, () -> studentController.updateStudent(),
                5, () -> studentController.deleteStudent()
        );
        ...
        while (!back) {
            ...
            actions.getOrDefault(
                    choice,
                    () -> studentController.getView().printInvalidChoice()
            ).run();
        }
    }
    ...
    private static void courseMenu() {
        ...
        Map<Integer, Runnable> actions = Map.of(
                ...
                2, () -> courseController.displayAllCourses(),
                3, () -> courseController.findCourseById(),
                4, () -> courseController.updateCourse(),
                5, () -> courseController.deleteCourse()
        );
        ...
        while (!back) {
            ...
            actions.getOrDefault(
                    choice,
                    () -> courseController.getView().printInvalidChoice()
            ).run();
        }
    }
    ...
    private static void enrollmentMenu() {
        ...
        Map<Integer, Runnable> actions = Map.of(
                ...
                5, () -> enrollmentController.viewUnenrolledStudents()
        );
        ...
        while (!back) {
            ...
            actions.getOrDefault(
                    choice,
                    () -> enrollmentController.getView().printInvalidChoice()
            ).run();
        }
    }
    ...
    private static void queryMenu() {
        ...
        Map<Integer, Runnable> actions = Map.of(
                ...
                2, () -> queryController.listStudentsWithCourses(),
                3, () -> queryController.findStudentsByName(),
        ...
        while (!back) {
            ...
            actions.getOrDefault(
                    choice,
                    () -> queryController.getView().printInvalidChoice()
            ).run();
        }
    }
}
