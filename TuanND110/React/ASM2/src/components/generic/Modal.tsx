...
export interface ModalProps {
  /** Controls visibility */
  isOpen: boolean;
  /** Called when user closes (backdrop, Escape, X button) */
  onClose: () => void;
  /** Modal heading */
  title?: string;
  /** Width preset */
  size?: 'sm' | 'md' | 'lg' | 'xl';
  /** Prevent close via backdrop/Escape while an action is loading */
 ...
 * Handles backdrop overlay, Escape key binding, body scroll-lock,
 * header with close button, body, and footer slots.
 */
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={[
          'w-full bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden',
          'animate-scaleIn text-slate-900',
          SIZE_MAP[size],
        ].join(' ')}
