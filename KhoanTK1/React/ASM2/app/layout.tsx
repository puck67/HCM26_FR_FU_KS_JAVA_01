...
export const metadata: Metadata = {
    title: "ASM2 - Todo Manager",
    description: "A powerful todo management application built with Next.js App Router, TypeScript, Tailwind CSS, and Formik.",
};
        ...
        >
            <body className={`${geist.className} bg-gray-950 text-gray-100 min-h-screen`}>
                ...
                <footer className="mt-16 border-t border-gray-800/60 py-6 text-center text-gray-600 text-sm">
                    © 2026 TodoFlow · Built with Next.js + TypeScript + Tailwind CSS
                </footer>
            </body>
        </html>
    );
