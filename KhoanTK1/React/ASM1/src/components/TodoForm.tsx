...
export function TodoForm({ isOpen, onClose, todoToEdit }: TodoFormProps) {
    ...
    const saveTodo = async (
        ...
        try {
            if (isEditMode && todoToEdit) {
                await updateTodo(todoToEdit.id, values);
            } else {
                    ...
                    {({ isSubmitting, errors, touched }) => (
                        <Form className="p-6 space-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                >
                                    Todo Name <span className="text-indigo-400">*</span>
                                </label>
                                <Field
                                    type="text"
                                    id="name"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Field
                                    ...
                                    name="description"
                                    rows={4}
                                    placeholder="Describe your todo objectives..."
