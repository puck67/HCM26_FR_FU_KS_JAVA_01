            ...
            <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-[#070b14] border-r border-white/5 p-6 shadow-2xl z-30">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] block text-indigo-400 font-semibold tracking-wider uppercase">
                            Dashboard
                        </span>
                    </div>
                </div>
                    ...
                    <div className="bg-slate-900/40 border border-white/5 p-4 rounded-2xl">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-xs font-semibold">
                                ...
                                <span className="text-emerald-400">{completedTodos}</span>
                            </div>
                            <div className="flex justify-between text-xs font-semibold">
                                <span className="text-slate-400">Pending:</span>
                                <span className="text-amber-400">{pendingTodos}</span>
                            </div>
                        </div>
                    </div>
                </nav>
