...
public class StudentDAOImpl implements StudentDAO {
    ...
    public List<Student> findOlderThan(int age) {
        // Dung HQL truy van sinh vien lon hon so tuoi truyen vao
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
    ...
    public List<Student> findByName(String name) {
        // Goi named query da khai bao o Entity
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
    ...
    public List<Object[]> findAllWithCourses() {
        // HQL Join lay sinh vien va ten cac khoa hoc da dang ky
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
    ...
    public List<Student> findStudentsEnrolledInCourse(int courseId) {
        // Lay danh sach sinh vien hoc khoa hoc cu the
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
