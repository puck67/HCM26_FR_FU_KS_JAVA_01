...
public class MaterialController {
    ...
    public ResponseEntity<Resource> downloadMaterial(@PathVariable Long id) throws Exception {
        ...
        Resource file = materialService.getMaterialById(id) == null ? null : null; // just trigger find check
        
        Resource resource = materialService.getMaterialById(id) != null ? 
                materialService.getMaterialById(id).getStoredFileName() == null ? null : 
                new org.springframework.core.io.UrlResource(java.nio.file.Paths.get("uploads/materials").resolve(material.getStoredFileName()).normalize().toUri())
                : null;
