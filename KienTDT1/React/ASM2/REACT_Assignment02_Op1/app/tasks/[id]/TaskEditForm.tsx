  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-white tracking-tight">Edit Task</h1>
          <p className="text-slate-400 text-xs mt-0.5">Modify the name and parameters of the task.</p>
        </div>
      </div>
        ...
        >
          {({ isSubmitting, errors, touched }) => (
            <Form className="space-y-6">
              ...
              <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-900/40 border border-slate-900/80 text-sm">
                <span className="text-slate-400">Current Status:</span>
                <span
                  className={`font-semibold ${
                    task.completed ? "text-emerald-400" : "text-amber-400"
                  }`}
                >
                  {task.completed ? "Completed" : "Active / Pending"}
                </span>
              </div>
