...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public List<Student> findOlderThan(int age) { return studentDAO.findOlderThan(age); }

    @Override
    public List<Object[]> findAllStudentsWithCourses() { return studentDAO.findAllStudentsWithCourses(); }

    @Override
    public List<Student> findByName(String name) { return studentDAO.findByName(name); }

    @Override
    public List<Student> findStudentsEnrolledInCourse(int courseId) { return studentDAO.findStudentsInCourse(courseId); }
}
