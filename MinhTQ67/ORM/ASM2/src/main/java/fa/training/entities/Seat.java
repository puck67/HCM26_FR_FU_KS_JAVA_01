...
/**
 * Entity mapped to SEAT table.
 *
 * Relationships:
 *   - ManyToOne with CinemaRoom (owns the FK: CINEMA_ROOM_ID)
 *
 * SEAT_STATUS values: 'Available', 'Not Available', 'Booked'
 * SEAT_TYPE   values: 'VIP', 'Normal'
 */
@Entity
@Table(name = "SEAT")
public class Seat {
    ...
    /**
     * ManyToOne owning side: holds the FK CINEMA_ROOM_ID in SEAT table.
     */
    ...
    /**
     * Valid values: 'Available', 'Not Available', 'Booked'
     */
    @Column(name = "SEAT_STATUS", nullable = false, length = 255)
    private String seatStatus;

    /**
     * Valid values: 'VIP', 'Normal'
     */
